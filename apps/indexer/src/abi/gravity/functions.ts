import { address, array, bool, bytes, bytes1, bytes32, bytes4, string, struct, uint256 } from '@subsquid/evm-codec'
...
export type ERROR_INSUFFICIENT_TOKEN_AMOUNTParams = FunctionArguments<typeof ERROR_INSUFFICIENT_TOKEN_AMOUNT>
export type ERROR_INSUFFICIENT_TOKEN_AMOUNTReturn = FunctionReturn<typeof ERROR_INSUFFICIENT_TOKEN_AMOUNT>

/** ERROR_INVALID_CANDIDATES_LENGTH() */
export const ERROR_INVALID_CANDIDATES_LENGTH = func('0x31a869a5', {}, string)
export type ERROR_INVALID_CANDIDATES_LENGTHParams = FunctionArguments<typeof ERROR_INVALID_CANDIDATES_LENGTH>
export type ERROR_INVALID_CANDIDATES_LENGTHReturn = FunctionReturn<typeof ERROR_INVALID_CANDIDATES_LENGTH>
...
export type ERROR_INVALID_MINIMUM_TOKENParams = FunctionArguments<typeof ERROR_INVALID_MINIMUM_TOKEN>
...
export type ERROR_INVALID_VOTE_SIGNER_ADDRESSParams = FunctionArguments<typeof ERROR_INVALID_VOTE_SIGNER_ADDRESS>
export type ERROR_INVALID_VOTE_SIGNER_ADDRESSReturn = FunctionReturn<typeof ERROR_INVALID_VOTE_SIGNER_ADDRESS>
...
export type ERROR_NOT_ALL_VOTES_REVEALEDParams = FunctionArguments<typeof ERROR_NOT_ALL_VOTES_REVEALED>
export type ERROR_NOT_ALL_VOTES_REVEALEDReturn = FunctionReturn<typeof ERROR_NOT_ALL_VOTES_REVEALED>
...
export type ERROR_POLL_ALREADY_FINALIZEDParams = FunctionArguments<typeof ERROR_POLL_ALREADY_FINALIZED>
export type ERROR_POLL_ALREADY_FINALIZEDReturn = FunctionReturn<typeof ERROR_POLL_ALREADY_FINALIZED>
...
export type ERROR_VOTE_HASH_CANNOT_BE_REPLAYEDParams = FunctionArguments<typeof ERROR_VOTE_HASH_CANNOT_BE_REPLAYED>
export type ERROR_VOTE_HASH_CANNOT_BE_REPLAYEDReturn = FunctionReturn<typeof ERROR_VOTE_HASH_CANNOT_BE_REPLAYED>

/** ERROR_VOTE_SIGNER_INVALID_SIGNATURE() */
export const ERROR_VOTE_SIGNER_INVALID_SIGNATURE = func('0x80bba5c2', {}, string)
export type ERROR_VOTE_SIGNER_INVALID_SIGNATUREParams = FunctionArguments<typeof ERROR_VOTE_SIGNER_INVALID_SIGNATURE>
export type ERROR_VOTE_SIGNER_INVALID_SIGNATUREReturn = FunctionReturn<typeof ERROR_VOTE_SIGNER_INVALID_SIGNATURE>
...
export const candidates = func('0x7de14242', {
    tokenId: uint256,
    pollId: uint256,
}, array(string))
...
export const remainingVotesCount = func('0xe25afda5', {
    tokenId: uint256,
    pollId: uint256,
}, uint256)
...
export const totalVotesCount = func('0xf65f9a7d', {
    tokenId: uint256,
    pollId: uint256,
}, uint256)
...
export const votesPerCandidates = func('0x28833187', {
    tokenId: uint256,
    pollId: uint256,
}, array(uint256))
