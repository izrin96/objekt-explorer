...
export const Finalized = event('0x069cb9cf3066619f9a83be465993a22843ea7baba731ac97ac208899985dc007', {
...
export const PollCreated = event('0x79fb617314647013123901234cea859ab2df200423a4048a35d9cf59437a9b64', {
    tokenId: uint256,
    pollId: uint256,
})
...
export const Revealed = event('0xa02957988806bd9d30dcd2845b047aa4f45bede519fbd15ebafe428505b0900f', {
    tokenId: indexed(uint256),
    pollId: indexed(uint256),
