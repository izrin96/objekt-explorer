...
export type ERROR_TO_ADDRESS_NOT_IN_WHITELISTParams = FunctionArguments<typeof ERROR_TO_ADDRESS_NOT_IN_WHITELIST>
export type ERROR_TO_ADDRESS_NOT_IN_WHITELISTReturn = FunctionReturn<typeof ERROR_TO_ADDRESS_NOT_IN_WHITELIST>

/** ERROR_WHITELIST_ALREADY_REMOVED() */
export const ERROR_WHITELIST_ALREADY_REMOVED = func('0xa5813f57', {}, string)
export type ERROR_WHITELIST_ALREADY_REMOVEDParams = FunctionArguments<typeof ERROR_WHITELIST_ALREADY_REMOVED>
export type ERROR_WHITELIST_ALREADY_REMOVEDReturn = FunctionReturn<typeof ERROR_WHITELIST_ALREADY_REMOVED>

/** ERROR_WHITELIST_NOT_INITIALIZED() */
export const ERROR_WHITELIST_NOT_INITIALIZED = func('0xf1af1e75', {}, string)
export type ERROR_WHITELIST_NOT_INITIALIZEDParams = FunctionArguments<typeof ERROR_WHITELIST_NOT_INITIALIZED>
export type ERROR_WHITELIST_NOT_INITIALIZEDReturn = FunctionReturn<typeof ERROR_WHITELIST_NOT_INITIALIZED>
...
/** uri(uint256) */
export const uri = func('0x0e89341c', {
    id: uint256,
}, string)
...
/** whitelists(uint256) */
export const whitelists = func('0xfe4d5add', {
    _0: uint256,
}, bool)
