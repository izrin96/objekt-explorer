...
export type ERROR_BLACKLISTED_MSG_SENDERParams = FunctionArguments<typeof ERROR_BLACKLISTED_MSG_SENDER>
export type ERROR_BLACKLISTED_MSG_SENDERReturn = FunctionReturn<typeof ERROR_BLACKLISTED_MSG_SENDER>

/** ERROR_CANNOT_TRANSFER_EXTERNALLY() */
export const ERROR_CANNOT_TRANSFER_EXTERNALLY = func('0xf304e990', {}, string)
export type ERROR_CANNOT_TRANSFER_EXTERNALLYParams = FunctionArguments<typeof ERROR_CANNOT_TRANSFER_EXTERNALLY>
export type ERROR_CANNOT_TRANSFER_EXTERNALLYReturn = FunctionReturn<typeof ERROR_CANNOT_TRANSFER_EXTERNALLY>

/** ERROR_INVALID_TOKEN_ID_RANGE() */
export const ERROR_INVALID_TOKEN_ID_RANGE = func('0xeab6fab3', {}, string)
export type ERROR_INVALID_TOKEN_ID_RANGEParams = FunctionArguments<typeof ERROR_INVALID_TOKEN_ID_RANGE>
export type ERROR_INVALID_TOKEN_ID_RANGEReturn = FunctionReturn<typeof ERROR_INVALID_TOKEN_ID_RANGE>

/** ERROR_NON_TRANSFERABLE_OBJEKT() */
export const ERROR_NON_TRANSFERABLE_OBJEKT = func('0x8a2969c8', {}, string)
export type ERROR_NON_TRANSFERABLE_OBJEKTParams = FunctionArguments<typeof ERROR_NON_TRANSFERABLE_OBJEKT>
export type ERROR_NON_TRANSFERABLE_OBJEKTReturn = FunctionReturn<typeof ERROR_NON_TRANSFERABLE_OBJEKT>
...
export type ERROR_NOT_AUTHORIZED_APPROVALParams = FunctionArguments<typeof ERROR_NOT_AUTHORIZED_APPROVAL>
export type ERROR_NOT_AUTHORIZED_APPROVALReturn = FunctionReturn<typeof ERROR_NOT_AUTHORIZED_APPROVAL>
...
export const approvalWhitelists = func('0x419e583d', {
    _0: address,
}, bool)
...
export type BatchUpdateObjektTransferabilityParams = FunctionArguments<typeof batchUpdateObjektTransferability>
export type BatchUpdateObjektTransferabilityReturn = FunctionReturn<typeof batchUpdateObjektTransferability>

/** blacklists(address) */
export const blacklists = func('0x16c02129', {
    _0: address,
}, bool)
...
export const isObjektTransferable = func('0xb2c03a50', {
    _0: uint256,
}, bool)
