...
import { DEFAULT_ADMIN_ROLE, ERROR_BLACKLISTED_MSG_SENDER, ERROR_CANNOT_TRANSFER_EXTERNALLY, ERROR_INVALID_TOKEN_ID_RANGE, ERROR_NON_TRANSFERABLE_OBJEKT, ERROR_NOT_ADMIN, ERROR_NOT_AUTHORIZED_APPROVAL, ERROR_NOT_MINTER, ERROR_ONLY_OWNER, ERROR_SENDER_NOT_ADMIN, MINTER_ROLE, OPERATOR_ROLE, UPGRADE_INTERFACE_VERSION, approvalWhitelists, balanceOf, blacklists, getApproved, getRoleAdmin, hasRole, isApprovedForAll, isObjektTransferable, name, ownerOf, proxiableUUID, supportsInterface, symbol, tokenByIndex, tokenOfOwnerByIndex, tokenURI, totalSupply } from './functions.js'
import type { ApprovalWhitelistsParams, BalanceOfParams, BlacklistsParams, GetApprovedParams, GetRoleAdminParams, HasRoleParams, IsApprovedForAllParams, IsObjektTransferableParams, OwnerOfParams, SupportsInterfaceParams, TokenByIndexParams, TokenOfOwnerByIndexParams, TokenURIParams } from './functions.js'
