...
module.exports = class Data1767292372306 {
  ...
  async up(db) {
    ...
    // Add new columns
    await db.query(`ALTER TABLE vote ADD COLUMN IF NOT EXISTS token_id INT4 NOT NULL DEFAULT 0;`);
    await db.query(`ALTER TABLE vote ADD COLUMN IF NOT EXISTS log_index INT4 NOT NULL DEFAULT 0;`);
    await db.query(`ALTER TABLE vote ADD COLUMN IF NOT EXISTS candidate_id INT4;`);
    ...
    await db.query(`CREATE INDEX IF NOT EXISTS idx_vote_token_id ON vote (token_id);`);
  ...
  async down(db) {
    ...
    await db.query(`ALTER TABLE vote ADD COLUMN IF NOT EXISTS contract TEXT NOT NULL DEFAULT '';`);
    await db.query(`ALTER TABLE vote ALTER COLUMN contract DROP DEFAULT;`);
    await db.query(`CREATE INDEX IF NOT EXISTS idx_vote_contract ON vote (contract);`);
  }
};
