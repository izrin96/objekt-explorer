module.exports = class Data1745716395199 {
  ...
  async up(db) {
    ...
    await db.query(`ALTER TABLE "public"."como_balance" DROP COLUMN "contract";`);

    // 2. add token_id column to como_balance
    await db.query(`ALTER TABLE "public"."como_balance" ADD COLUMN "token_id" numeric NOT NULL;`);

    // 3. add an index on owner
    await db.query(`CREATE INDEX "IDX_como_balance_owner" ON "public"."como_balance" ("owner");`);
  ...
  async down(db) {
    ...
    await db.query(`ALTER TABLE "public"."como_balance" DROP COLUMN "token_id";`);

    // 5. add the contract column to como_balance
    await db.query(`ALTER TABLE "public"."como_balance" ADD COLUMN "contract" text NOT NULL;`);
  }
};
