module.exports = class Data1721359520021 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE INDEX "IDX_e955d648996ebf3ae54bfa4c40" ON "como_balance" ("contract") `);
    ...
    await db.query(`CREATE INDEX "IDX_8056b2df70cd298ce447bc186f" ON "vote" ("candidate_id") `);
