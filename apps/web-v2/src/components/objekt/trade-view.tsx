...
import ErrorFallbackRender, { ErrorRender } from "../error-boundary";
...
function TradeTable({ objekt, serial }: { objekt: ValidObjekt; serial: number }) {
  ...
  if (status === "error")
    return <ErrorRender onRetry={() => refetch()} message="Error loading objekt" />;
    ...
    <>
      ...
      <Card className="py-0">
        <CardContent className="px-3">
          ...
          >
            <TableHeader>
              <TableColumn isRowHeader>Owner</TableColumn>
