  ...
  return (
    <span data-slot="control" className="relative block w-full">
      <InputPrimitive
        ref={ref}
        className={cx(
          "relative block w-full appearance-none rounded-lg bg-(--control-bg,transparent) px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)]",
  ...
  return (
    <Group
      ...
      className={cx(
        ...
        // icon
        "has-[>[data-slot=icon]:first-child]:[&_input]:ps-8 has-[>[data-slot=icon]:last-child]:[&_input]:pe-8",
        "*:data-[slot=icon]:pointer-events-none *:data-[slot=icon]:absolute *:data-[slot=icon]:top-2.5 *:data-[slot=icon]:z-10 *:data-[slot=icon]:size-4",
        "[&>[data-slot=icon]:first-child]:start-2.5 [&>[data-slot=icon]:last-child]:end-2.5",

        // loader
        "has-[[data-slot=loader]:first-child]:[&_input]:ps-8 has-[[data-slot=loader]:last-child]:[&_input]:pe-8",
        "*:data-[slot=loader]:pointer-events-none *:data-[slot=loader]:absolute *:data-[slot=loader]:top-2.5 *:data-[slot=loader]:z-10 *:data-[slot=loader]:size-4",
        "[&>[data-slot=loader]:first-child]:start-2.5 [&>[data-slot=loader]:last-child]:end-2.5",

        // text
        "has-[[data-slot=text]:first-child]:[&_input]:ps-(--input-gutter-start,--spacing(10)) has-[[data-slot=text]:last-child]:[&_input]:pe-(--input-gutter-end,--spacing(10))",
        ...
        "[&>[data-slot=text]:first-child:not([class*='start-'])]:start-2.5 [&>[data-slot=text]:last-child:not([class*='end-'])]:end-2.5",

        // keyboard
        "has-[[data-slot=keyboard]:first-child]:[&_input]:ps-(--input-gutter-start,--spacing(10)) has-[[data-slot=keyboard]:last-child]:[&_input]:pe-(--input-gutter-end,--spacing(10))",
        ...
        "[&>[data-slot=keyboard]:first-child:not([class*='start-'])]:start-2.5 [&>[data-slot=keyboard]:last-child:not([class*='end-'])]:end-2.5",

        // button
        "has-[>button:first-child]:[&_input]:ps-(--input-gutter-start,--spacing(14)) has-[>button:last-child]:[&_input]:pe-(--input-gutter-end,--spacing(14))",
        "[&>button:first-child]:rounded-e-none [&>button:last-child]:rounded-s-none",
        "[&>button[data-intent=outline]]:border-input *:[button]:absolute *:[button]:top-0 *:[button]:z-10 *:[button]:min-h-9",
