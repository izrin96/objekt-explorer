        ...
        return (
          <div
            className={twMerge(
              ...
              "*:data-[slot=indicator]:col-start-1 *:data-[slot=indicator]:row-start-1 *:data-[slot=indicator]:mt-1",
          ...
          >
            <span
              data-slot="indicator"
              className={twMerge([
                "inset-ring-input text-bg hover:before:bg-muted-fg/20 before:size-1.7 relative isolate flex size-4 shrink-0 items-center justify-center rounded-full bg-(--control-bg,transparent) inset-ring transition before:absolute before:inset-auto before:size-2 before:shrink-0 before:rounded-full before:content-['']",
                ...
                isFocusVisible && [
                  "ring-3 ring-(--radio-ring,var(--color-ring))/20 inset-ring-(--radio-ring,var(--color-ring))",
