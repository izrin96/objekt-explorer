  ...
  return (
    <PrimitiveDialog
      ...
      className={twMerge(
        ...
        // add min-w-0
        // overflow-hidden to overflow-clip
        "peer/dialog group/dialog relative flex max-h-[calc(var(--visual-viewport-height)-var(--visual-viewport-vertical-padding))] min-w-0 flex-col overflow-clip outline-hidden [--gutter:--spacing(6)] sm:[--gutter:--spacing(6)]",
        className,
      )}
      {...props}
    />
