                ...
                {(date) => (
                  <CalendarCell
                    ...
                    className={twMerge([
                      ...
                      "group/calendar-cell selection-start:rounded-s-lg data-outside-month:text-muted-fg relative size-11 cursor-default leading-[2.286rem] outline-hidden data-selection-end:rounded-e-lg sm:size-9 sm:text-sm",
                      ...
                      date.compare(now) === 0 &&
                        "after:bg-primary selected:after:bg-primary-fg after:pointer-events-none after:absolute after:start-1/2 after:bottom-1 after:z-10 after:size-0.75 after:-translate-x-1/2 after:rounded-full",
                    ])}
                  >
                    {({
                      formattedDate,
