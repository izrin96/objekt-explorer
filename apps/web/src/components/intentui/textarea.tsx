  ...
  return (
    <span data-slot="control" className="relative block w-full">
      <TextArea
        ...
        className={cx(
          twJoin([
            "relative block field-sizing-content min-h-16 w-full appearance-none rounded-lg bg-(--control-bg,transparent) px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)]",
            "text-fg placeholder:text-muted-fg text-sm/6",
