...
| `/@nickname/progress` | **Show Count** | `ShowCountFilter` (`apps/website/src/components/profile/progress/filter-showcount.tsx`), `showCount` URL param, wired at `progress-filter.tsx:36`. | Absent — no control, no param, no schema entry. | **P2** |
